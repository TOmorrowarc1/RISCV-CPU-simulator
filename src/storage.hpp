...
extern StatusRegister EXE_IF_reg_pc;          // for BPU refresh: the pc.
extern StatusRegister EXE_IF_reg_target_addr; // for BPU refresh: the pc.
extern StatusRegister EXE_IF_reg_if_jump;     // for BPU refresh: the pc.
